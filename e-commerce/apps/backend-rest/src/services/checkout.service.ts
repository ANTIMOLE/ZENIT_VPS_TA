...
export async function getCheckoutSummary(userId: string, orderNumber: string) {
  ...
  // Test rest.test.ts line 610 expect typeof total === 'number' gagal karena total = "1500.00" (string).
  // tRPC lolos karena tRPC punya serializer sendiri. REST harus manual convert.
  return {
    ...checkout,
