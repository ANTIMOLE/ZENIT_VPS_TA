  ...
  return (
    <div className="space-y-6 max-w-6xl">
      ...
      <div>
        ...
        <p className="text-sm text-zinc-500 mt-0.5">Ringkasan performa toko hari ini</p>
      </div>
          ...
          : [
              ...
              <div key={i} className="bg-white rounded-xl border border-zinc-200 p-5">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className={cn("w-8 h-8 rounded-lg flex items-center justify-center", card.accent)}>
        ...
        <div className="bg-white rounded-xl border border-zinc-200">
          <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-200">
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-sm text-zinc-900">Produk Terlaris</p>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="divide-y divide-zinc-100">
              {data?.topProducts.slice(0, 8).map((product, rank) => (
                <div key={product.id} className="flex items-center gap-3 px-5 py-3">
                  ...
                  <div className="relative w-8 h-8 rounded-lg overflow-hidden bg-zinc-100 flex-shrink-0">
                    <ProductThumb images={product.images} alt={product.name} sizes="32px" />
                  </div>
                  {/* Info */}
                  ...
                  <div className="text-right flex-shrink-0">
                    ...
                    <p className={cn(
                      "text-xs",
                      product.stock < 10 ? "text-red-500" : "text-zinc-400"
                    )}>
                      stok: {product.stock}
                    </p>
                  </div>
              ...
              {!data?.topProducts.length && (
                <p className="text-sm text-zinc-400 text-center py-8">Belum ada data produk</p>
              )}
            </div>
          )}
        </div>
        ...
        <div className="bg-white rounded-xl border border-zinc-200">
          <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-200">
            <div className="flex items-center gap-2">
              ...
              <p className="font-semibold text-sm text-zinc-900">Pesanan Terbaru</p>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="divide-y divide-zinc-100">
              ...
              {!data?.recentOrders.length && (
                <p className="text-sm text-zinc-400 text-center py-8">Belum ada pesanan</p>
              )}
            </div>
          )}
        </div>
